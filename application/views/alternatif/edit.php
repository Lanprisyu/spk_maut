...
<div class="card shadow mb-4">
	<div class="card-header py-3">
		<h6 class="m-0 font-weight-bold text-dark"><i class="fas fa-fw fa-edit"></i> Edit Data Pegawai</h6>
	</div>
	...
	<div class="card-body">
		...
		<div class="row">
			<div class="form-group col-md-12">
				...
				<input autocomplete="off" type="text" name="jabatan" value="<?php echo $alternatif->jabatan ?>" required class="form-control" />
			</div>
		</div>
	</div>
