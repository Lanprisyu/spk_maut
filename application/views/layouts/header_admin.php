 ...
 <head>
   ...
   <link rel="shortcut icon" href="<?= base_url('assets/') ?>img/Sumatra.png" type="image/x-icon">
   <link rel="icon" href="<?= base_url('assets/') ?>img/Sumatra.png" type="image/x-icon">
 ...
 <body id="page-top">
   ...
   <div id="wrapper">
     ...
     <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
       ...
       <!-- Sidebar - Brand -->
       <a class="sidebar-brand d-flex align-items-center justify-content" href="<?= base_url('Login/home'); ?>">
         <div class="sidebar-brand-icon ">
           <img style="width: 3rem;" src="<?= base_url('assets/img/Sumatra.png') ?>" />
         </div>
         <div class="sidebar-brand-text mx-2">Diskominfotik</div>
       </a>
